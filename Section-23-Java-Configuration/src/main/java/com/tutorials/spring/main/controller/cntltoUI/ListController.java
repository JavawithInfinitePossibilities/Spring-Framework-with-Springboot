...
public class ListController implements ApplicationContextAware {
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		System.out.println("this is application contest override method");
		employees = Arrays.asList((Employee) applicationContext.getBean("employee"), (Employee) applicationContext.getBean("employee"),
